            ...
            @include('superAdmin.inc.messages')
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <div class="clearfix"></div>
                    <a href="{{ url('reservationSteps')}}" class="btn btn-success">Add Room Reservation</a>
                    <table id="room-reservation-table" class="table table-striped table-bordered dataTable no-footer">
                      <thead>
                        <th>Transac code</th>
                        <th>Client fname</th>
                        <th>Client lname</th>
